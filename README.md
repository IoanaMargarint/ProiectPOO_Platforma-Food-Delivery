...
## Ierarhia claselor
Clasele sunt organizate în două ierarhii separate, una pentru utilizatori și una pentru recenzii. Pentru utilizatori, clasa de bază este Utilizator, care conține datele comune (nume, telefon, ID). Din ea derivă Client, care adaugă o adresă de livrare, și Curier, care adaugă vehiculul folosit. 
